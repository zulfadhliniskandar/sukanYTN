<div class="max-w-3xl mx-auto py-10">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        <form wire:submit="save" class="p-8 space-y-6">
            <!-- Sport Name -->
            <div>
                <label for="name" class="block text-sm font-semibold text-slate-700 mb-2">Sport Name <span class="text-red-500">*</span></label>
                <div class="relative">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Venue Selection -->
                <div>
                    <label for="venue" class="block text-sm font-semibold text-slate-700 mb-2">Venue <span class="text-red-500">*</span></label>
                ...
                <!-- Type Selection -->
                <div>
                    <label for="type" class="block text-sm font-semibold text-slate-700 mb-2">Event Type <span class="text-red-500">*</span></label>
