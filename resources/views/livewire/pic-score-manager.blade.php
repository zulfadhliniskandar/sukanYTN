        ...
        <div class="p-8 space-y-6">
            <div class="space-y-4">
                @foreach($match->participants as $participant)
                    <div class="flex items-center justify-between p-5 bg-slate-50/70 rounded-2xl border border-slate-100 transition-all hover:shadow-sm">
                        <span class="font-bold text-slate-800 truncate pr-4 capitalize">{{ $participant->user->name }}</span>
                        <div class="flex items-center gap-3">
                            ...
                            <span class="w-12 text-center font-black text-2xl text-indigo-650 text-indigo-600">{{ $participant->score }}</span>
            ...
            @if($match->status === 'ongoing')
                <div class="pt-6 border-t border-slate-100">
                    <button wire:confirm="Are you sure you want to end this match?"
