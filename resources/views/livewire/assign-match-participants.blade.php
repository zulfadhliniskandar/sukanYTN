    ...
    <div class="bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden">
        ...
        <form wire:submit="saveParticipant" class="p-8 space-y-6">
            ...
            @if (session()->has('warning'))
                <div class="rounded-2xl bg-amber-50 p-4 border border-amber-100 flex items-center shadow-sm">
                    <div class="flex-shrink-0 bg-amber-100 rounded-full p-2 mr-4 text-amber-600">
