    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex items-center min-w-0">
                ...
                <!-- Navigation Links -->
                <div class="hidden md:flex md:items-center space-x-3 lg:space-x-6 -my-px ms-6 lg:ms-8">
                    ...
                    <x-nav-link :href="route('registerSport')" :active="request()->routeIs('registerSport')" wire:navigate class="whitespace-nowrap">
                        {{ __('Register Sport') }}
                    </x-nav-link>
                    @impersonating
            ...
            <!-- Settings Dropdown -->
            <div class="hidden md:flex md:items-center md:ms-6 shrink-0">
